...
class PropertySold(models.TransientModel):
    ...
    def default_get(self, fields):
        ...
        if sell_id.book_invoice_payment_state != 'paid' and sell_id.property_id.type == 'land' and sell_id.property_id.stage == 'booked' and malipopay:
            raise ValidationError(
                    _("You cannot confirm sale until the booking amount is received"))
        if sell_id.property_id.stage == 'sold' and sell_id.property_id.type == 'land':
            raise ValidationError(
                _("This property is already sold either you can refund or cancel the booking"))
