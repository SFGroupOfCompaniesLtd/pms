...
class PropertyProject(models.Model):
    ...
    scope_of_collection = fields.Monetary(string="Scope of Collection",
                                          compute="compute_properties_statics")
    total_contract_collection = fields.Monetary(string="Total Contract Collection",
                                                compute="compute_properties_statics")
    ...
    def compute_properties_statics(self):
        for rec in self:
            ...
            if rec.sale_lease == 'sale':
                ...
                total_contract_collection = sum(
                    properties_tenancy.mapped('total_amount'))
            ...
            rec.total_contract_collection = total_contract_collection
